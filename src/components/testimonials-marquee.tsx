...
const testimonials = [
  {
    ...
    username: "@alxchen",
    content:
      "Twitmark completely changed how I curate my X feed. The folder system is genius!",
    rating: 5,
  },
  {
    name: "Sarah Miller",
    username: "@sarahm",
    content:
      "Finally, a bookmark manager that understands X. Reading mode is a game changer.",
    rating: 5,
  },
  {
    name: "James Wilson",
    username: "@jwilson",
    content:
      "I've saved hundreds of valuable tweets. Twitmark helps me actually read them.",
    rating: 5,
  },
  {
    name: "Emily Davis",
    username: "@emilyd",
    content:
      "Clean, fast, and beautiful. Exactly what I needed for organizing my X bookmarks.",
    rating: 5,
  },
  {
    name: "Michael Brown",
    username: "@mikeb",
    content:
      "The glassmorphism UI is stunning. Makes bookmarking actually enjoyable.",
    rating: 5,
  },
  {
    name: "Lisa Taylor",
    username: "@lisat",
    content:
      "I used to lose tweets in my likes. Now I have everything organized perfectly.",
    rating: 5,
  },
];
...
export default function TestimonialsMarquee() {
  return (
    <section className="overflow-hidden border-y border-white/10 bg-black/20 backdrop-blur-sm py-16">
