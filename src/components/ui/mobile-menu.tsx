        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              exit={{ opacity: 0, x: 20 }}
              transition={{ duration: 0.15 }}
              className="bg-secondary border-border/40 fixed top-[64px] right-0 z-[60] flex h-[calc(100vh-64px)] w-full items-center justify-center overflow-hidden border shadow-lg backdrop-blur"
              role="menu"
            >
